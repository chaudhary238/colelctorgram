...
const CATEGORIES = [
  { id: 'figures',  label: 'Action Figures',           short: 'Action Figures' },
  { id: 'designer', label: 'Designer Toys & Blind Boxes', short: 'Designer Toys' },
  { id: 'kits',     label: 'Model Kits & Lego',           short: 'Model Kits' },
...
const USERS = {
  aman_toys: {
    ...
    seasonBadges: [
      { id: 'aman-may-posts', period: 'May', kind: 'posts', place: 1, tier: 'gold', title: 'Top Showcaser' },
  ...
  rohit_scale: {
    ...
    seasonBadges: [
      { id: 'vik-may-mo', period: 'May', kind: 'monthly', place: 1, tier: 'gold', title: '#1 · Monthly' },
      { id: 'vik-may-mkt', period: 'May', kind: 'market', place: 1, tier: 'gold', title: 'Top Trader' },
      { id: 'vik-apr-mo', period: 'Apr', kind: 'monthly', place: 1, tier: 'gold', title: '#1 · Monthly' },
    ],
  ...
  karan_die: {
    ...
    seasonBadges: [
      { id: 'karan-may-mkt', period: 'May', kind: 'market', place: 3, tier: 'bronze', title: '#3 · Trader' },
    ],
  ...
  meera: {
    ...
    seasonBadges: [
      { id: 'meera-may-social', period: 'May', kind: 'social', place: 1, tier: 'gold', title: 'Top Connector' },
      { id: 'meera-apr-mo', period: 'Apr', kind: 'monthly', place: 3, tier: 'bronze', title: '#3 · Monthly' },
    ],
  ...
  vikram: {
    ...
    seasonBadges: [
      { id: 'rohit-may-coll', period: 'May', kind: 'collection', place: 1, tier: 'gold', title: 'Top Archivist' },
      { id: 'rohit-may-mo', period: 'May', kind: 'monthly', place: 2, tier: 'silver', title: '#2 · Monthly' },
      { id: 'rohit-mar-coll', period: 'Mar', kind: 'collection', place: 1, tier: 'gold', title: 'Top Archivist' },
    ],
...
const MY_ITEMS = [
  ...
  { id: 'i5', sku: 'SHF-GUI', status: 'preorder', verify: 'claimed',  value: 6800,  listed: false, photos: 0,
    order: 'Ordered 12 May', eta: 'Ships ~ 20 Jun', etaMonth: 5, etaYear: 2026 },
  { id: 'i6', sku: 'MG-RX78', status: 'preorder', verify: 'claimed',  value: 4800,  listed: false, photos: 0,
    order: 'Ordered 2 Jun', eta: 'Ships ~ 28 Jun', etaMonth: 5, etaYear: 2026 },
  { id: 'i7', sku: 'SS-PF-BM',status: 'preorder', verify: 'claimed',  value: 165000,listed: false, photos: 0,
    order: 'Ordered 9 Jun', eta: 'Ships ~ Sep', etaMonth: 8, etaYear: 2026 },
...
const EVENTS = [
  ...
  { id: 'online1', title: 'Pop Mart Drop · Online Watch Party', day: 'Fri', date: '06', month: 'Jun',
    when: 'Fri · 06 Jun · 8:00 – 9:30 pm', time: '8:00 pm', endTime: '9:30 pm',
    where: 'CollectorHub Live (online)', mode: 'Online', city: 'Online',
    cats: ['designer'], status: 'approved', host: 'meera', community: 'kaiju',
...
const ME = {
  ...
  seasonBadges: [
    { id: 'you-may-wk', period: 'May', kind: 'weekly', place: 'top10', tier: 'finalist', title: 'Weekly Top 10' },
    { id: 'you-apr-social', period: 'Apr', kind: 'social', place: 3, tier: 'bronze', title: '#3 · Connector' },
  ],
...
const OWN_LABELS = { figures: 'action figures', designer: 'designer toys & blind boxes', kits: 'kits & Lego', diecast: 'diecast' };
...
const REWARD_TIERS = [
  ...
  { id: 'fan',        name: 'Fan',       at: 250,  c: 'var(--forest)',           icon: Icons.sparkle, perk: 'Profile flair unlocked' },
  { id: 'collector',  name: 'Collector', at: 750,  c: 'var(--verified-teal)',    icon: Icons.medal,   perk: 'Early drop alerts' },
  { id: 'pro',        name: 'Pro',       at: 1800, c: 'var(--plum)',             icon: Icons.gem,     perk: 'Showcases get featured' },
  { id: 'expert',     name: 'Expert',    at: 4000, c: 'var(--grail-gold-deep)',  icon: Icons.flame,   perk: 'Priority verification' },
  { id: 'legend',     name: 'Legend',    at: 8000, c: 'var(--stamp-red)',        icon: Icons.crown,   perk: 'Legend badge + spotlight' },
];
...
const EARN_ACTIONS = [
  { id: 'profile',  label: 'Complete your profile', xp: 50, icon: Icons.user,     type: 'once',  progress: { done: 3, total: 5 } },
  { id: 'item',     label: 'Add a verified item',   xp: 20, icon: Icons.box,      type: 'repeat' },
  { id: 'showcase', label: 'Post a showcase',       xp: 15, icon: Icons.camera,   type: 'repeat' },
  { id: 'review',   label: 'Write a review',        xp: 15, icon: Icons.star,     type: 'repeat' },
  { id: 'vouch',    label: 'Vouch for a collector', xp: 10, icon: Icons.shield,   type: 'repeat' },
  { id: 'event',    label: 'RSVP to an event',      xp: 10, icon: Icons.calendar, type: 'repeat' },
  { id: 'comment',  label: 'Comment on a post',     xp: 5,  icon: Icons.comment,  type: 'repeat' },
  { id: 'like',     label: 'Like a post',           xp: 1,  icon: Icons.heart,    type: 'repeat' },
  { id: 'checkin',  label: 'Daily check-in',        xp: 5,  icon: Icons.zap,      type: 'daily' },
  { id: 'refer',    label: 'Refer a friend',        xp: 40, icon: Icons.gift,     type: 'repeat' },
];
...
const BADGE_KIND = {
  ...
  monthly:    { icon: Icons.trophy, label: 'Monthly league' },
  market:     { icon: Icons.swap,   label: 'Trader season' },
  social:     { icon: Icons.heart,  label: 'Connector season' },
  posts:      { icon: Icons.camera, label: 'Showcaser season' },
  collection: { icon: Icons.gem,    label: 'Archivist season' },
};
...
function leaderboard(period = 'week') {
  ...
  const pointsOf = (u) => byCategory
    ? (u.contrib ? u.contrib[period] || 0 : 0)
    : u[period === 'week' ? 'xpWeek' : period === 'month' ? 'xpMonth' : 'xp'];
  return all
    .map(u => ({ key: u.key, handle: u.handle, name: u.name, color: u.color, points: pointsOf(u), tier: tierOf(u.xp), arche: archetypeOf(u), isMe: u.isMe }))
...
Object.assign(window, {
  ...
  REWARD_TIERS, EARN_ACTIONS, ARCHETYPES, CONTRIB_LABELS, tierOf, tierIndexOf, nextTierOf, leaderboard, archetypeOf, contribMix,
