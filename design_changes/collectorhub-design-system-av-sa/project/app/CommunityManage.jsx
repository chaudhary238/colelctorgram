                  ...
                  return (
                    <div key={h} style={{ display: 'flex', alignItems: 'center', gap: 11, padding: 11, background: 'var(--paper-soft)', border: '1px solid var(--border)', borderRadius: 13 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}><span style={{ fontWeight: 600, fontSize: 14 }}>{u.name}</span><TierChip tier={u.tier}/></div>
                ...
                <div key={m.handle} style={{ display: 'flex', alignItems: 'center', gap: 11, padding: 10, background: 'var(--paper-soft)', border: '1px solid var(--border)', borderRadius: 13 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      ...
                      {m.role && <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9.5, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '2px 6px', borderRadius: 6, background: isFounder ? 'var(--ink)' : 'var(--bone-deep)', color: isFounder ? 'var(--paper)' : 'var(--ink-mute)', fontWeight: 700 }}>{m.role}</span>}
                    </div>
