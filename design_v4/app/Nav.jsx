...
function AppStateProvider({ children }) {
  ...
  const value = {
    ...
    userEvents, rsvp, userCommunities, eventCommunityDraft, reminders, wishlistedSkus, liveNotifs, removedSkus,
    ...
    addEvent, approveEvent, cancelEvent, setEventRsvp, addCommunity, bindEventCommunity, clearEventCommunityDraft, toggleReminder, toggleWishlistSku, removeItem,
  };
