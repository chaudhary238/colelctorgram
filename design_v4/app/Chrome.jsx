...
function BottomNav() {
  ...
  return (
    <div style={{ flexShrink: 0, paddingBottom: 30, background: 'var(--paper)', boxShadow: '0 -1px 0 var(--slate-200), 0 -8px 24px rgba(0,0,0,0.05)' }}>
      <div style={{ display: 'flex', alignItems: 'stretch', padding: '10px 6px 2px' }}>
        {tabs.map(t => {
