            ...
            {[{
              ...
              <button key={label} onClick={onClick} disabled={!onClick} style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: 20, lineHeight: 1 }}>{label === 'Deals' ? '🤝' : label === 'Followers' ? '👥' : '🛡️'}</span>
                </div>
                <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 22, color: 'var(--s900)', lineHeight: 1, letterSpacing: '-0.04em' }}>{compactNum(n)}</span>
