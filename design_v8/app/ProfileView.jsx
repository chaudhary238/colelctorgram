...
function ProfileView({ route }) {
  ...
  // Seed items + quick-adds, with later-filled details patched over the top.
  const myItems = resolveMyItems(appState);
      ...
      <div style={{ padding: '18px 16px 0' }}>
        ...
        <div style={{ marginTop: 14 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginTop: 3, flexWrap: 'wrap' }}>
            <span style={{ fontSize: 13, color: 'var(--slate-400)' }}>@{u.handle} · {placeLabel(u)}</span>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
      ...
      <div style={{ padding: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px', background: 'var(--paper-soft)', border: '1px solid var(--border)', borderRadius: 14 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <div style={{ fontSize: 12.5, color: 'var(--ink-faint)' }}>@{u.handle} · {placeLabel(u)}</div>
          </div>
        </div>
