...
function FeedView() {
  ...
  return (
    <Screen header={<AppBar title="Scorred" wordmark/>}>
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 5, background: 'var(--paper)', borderBottom: '1px solid var(--slate-200)', padding: '12px 16px' }}>
        ...
        <div style={{ position: 'relative', margin: '10px -14px 0' }}>
          <div ref={tagBar}
            ...
            {/* customise feed — trailing ⚙ chip */}
            <button onClick={() => { if (!drag.current.moved) { customOpen ? setCustomOpen(false) : openCustomise(); } }} draggable={false} style={{
              ...
              <Ico d={Icons.sliders} size={14} stroke={2.1}/>
              Customise
            </button>
          </div>
        </div>
