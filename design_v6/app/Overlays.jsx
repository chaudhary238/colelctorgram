    ...
    <OverlayShell title="Create a post" onBack={() => setKind(null)} onClose={() => setOverlay(null)}
      ...
      <div style={{ padding: '14px 16px 24px' }}>
        ...
        <div style={{ marginTop: 20 }}>
          ...
          <div style={{ fontSize: 11.5, color: 'var(--ink-faint)', marginTop: 3 }}>Helps the right collectors find your post</div>
        </div>
          ...
          {CATEGORIES.map(c => {
            ...
            return (
              <button key={c.id} onClick={() => toggleCat(c.id)} style={{
                ...
                borderRadius: 999, border: `1px solid ${on ? 'var(--ink)' : 'var(--border-strong)'}`,
                ...
                {on && <Ico d={Icons.check} size={13} stroke={3}/>}
                {c.chipLabel}
              </button>
            );
          })}
        ...
        {/* hashtags — all types */}
        <div style={{ marginTop: 20 }}><SectionLabel>Hashtags</SectionLabel></div>
