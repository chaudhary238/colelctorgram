      ...
      <div style={{ padding: '18px 16px 0' }}>
        ...
        {isMe ? (
          <div style={{ display: 'flex', gap: 8, marginTop: 14 }}>
            ...
            <Button variant="secondary" style={{ flex: 1, justifyContent: 'center' }} icon={<Ico d={Icons.plusCircle} size={17}/>}
              onClick={() => push({ name: 'add-listing' })}>Add item</Button>
            <IconButton icon={<Ico d={Icons.gift} size={18}/>} onClick={() => push({ name: 'refer' })}/>
