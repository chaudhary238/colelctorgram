...
function AppStateProvider({ children }) {
  ...
  const removeItem = (sku) => setRemovedSkus(r => ({ ...r, [sku]: true })); // sku -> true (wishlisted from others' profiles)
  ...
  const value = {
    hearted, saved, followed, joined, comRequested, interested, readNotifs, threads, deals, listingStatus, posts, userListings, profile, vouched,
    userEvents, rsvp, userCommunities, eventCommunityDraft, reminders, liveNotifs, removedSkus,
    toggleHeart, toggleSave, toggleFollow, toggleJoin, requestJoin, cancelRequest, toggleInterested,
    ...
    addEvent, approveEvent, cancelEvent, setEventRsvp, addCommunity, bindEventCommunity, clearEventCommunityDraft, toggleReminder, removeItem,
  };
