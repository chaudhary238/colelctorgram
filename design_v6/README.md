# Scorred Design System (v6)

> **Scorred** (renamed from CollectorHub in v6) is a community-first social platform for hobby collectors in India — showcase, discover, connect, and trade. Categories: Action Figures · Designer Toys & Blind Boxes · Model Kits & Lego · Diecast · Trading Cards (TCG).
>
> Tagline: *"Track, trade & network — Score every grail on India's #1 collectibles platform."*
